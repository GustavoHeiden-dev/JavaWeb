...
<body>
	...
	<div class="container">
				...
				<tbody>
					...
					<tr>
						...
						<td class="action-cell">
						    <a href='editar.jsp?id=<%=c.getId()%>'><button>Editar</button></a>
						</td>
					</tr>
					<%
					}
		...
		<a href="./CadastroCli.html" class="btn-voltar">Cadastrar Novo
			Cliente</a> <a href="./Index.html" class="btn-voltar">Voltar para
			Home</a>
